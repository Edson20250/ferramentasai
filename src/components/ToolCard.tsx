                        ...
                        <span className="text-xs bg-amber-50 text-amber-700 px-1.5 py-0.5 rounded font-medium">
                                  ...
                                  <div className="flex items-center justify-between gap-2 flex-wrap">
                                              ...
                                              <a
                                                              ...
                                                              className="text-xs font-medium text-emerald-700 hover:text-emerald-800 flex items-center gap-0.5 transition-colors group/link"
                                                            >
                                                            Visitar
                                                            <span className="transition-transform duration-150 group-hover/link:translate-x-0.5">→</span>span>
                                              </a>a>
                                  </div>div>
                        </div>div>
                </div>div>
